    ...
    >
      ...
      <div style="max-width: 900px; margin: 0 auto; padding-left: 16px; padding-right: 16px;">
        ...
        <div class="mt-5 mx-auto">
          ...
          <p class="text-muted">
            陈雨孜、段艺璇、黄怡慈（BEJ48 Team B兼任）、芦馨怡、刘增艳、宁轲、彭嘉敏、沈小爱、田姝丽、由淼、闫明筠、杨心渝、张雷雷、张倩、赵天杨、冯雪（预备生）、蒋夏羽（预备生）、盛乐（预备生）
          </p>
        </div>
        ...
        <div class="mt-5 mx-auto">
          ...
          <p class="text-muted">
            黄恩茹、李慧、马玉灵、邵雪聪、朱涵佳、刘倩倩（GNZ48 Team NIII兼任，GNZ48荣誉毕业生）
          </p>
        </div>
        ...
        <div class="mt-5 mb-5 mx-auto">
          ...
          <p class="text-muted">
            林佳怡、禹佳蔚、武博涵、张月铭、王依柳、熊紫轶、刘小涵、吕相宜、卢晨昕、李虞龙若、温若其、许佳佳、尤可莹、张怡婷、梁怀方、唐程成、王悦垚、王紫澍、叶凡、张瀚引、陈真允一、罗颍宸、温冰冰、吴欣怡、夏奕欣、张曼妮、陈芷晴、潘力帼、陈俞希、金泓言、李妍、李子忻、杨秋野（原名孙莉）、肖彦竹
          </p>
        </div>
